...
public function addMoreActionsButtons($parameters, &$object, &$action, $hookmanager)
{
 ...
 // Fetch the current revision value from the object's extra fields
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        customAlert.innerHTML = "Proposal Revision is: " + currentRevision;
        customAlert.style.position = "fixed";
        customAlert.style.top = "60px";
        customAlert.style.left = "50%";
        customAlert.style.transform = "translateX(-50%)";
        //customAlert.style.backgroundColor = "#f0ad4e";
        customAlert.style.backgroundColor = "Blue";
        customAlert.style.color = "#fff";
        customAlert.style.padding = "10px 20px";
        customAlert.style.borderRadius = "5px";
        customAlert.style.boxShadow = "0px 2px 10px rgba(0, 0, 0, 0.2)";
        customAlert.style.zIndex = "1000";
        document.body.appendChild(customAlert);

        // Auto-hide after 2 seconds
        setTimeout(function() {
            customAlert.style.transition = "opacity 0.5s ease";
        ...
        var fields = document.querySelectorAll("form input, form textarea, form select");Q
        var isModified = false;
