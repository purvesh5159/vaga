...
/**
 * \file    productcustomreferencenumber/core/boxes/productcustomreferencenumberwidget1.php
 * \ingroup productcustomreferencenumber
 * \brief   Widget provided by ProductCustomReferenceNumber
 *
 ...
 */
class productcustomreferencenumberwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "productcustomreferencenumberbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "productcustomreferencenumber@productcustomreferencenumber";
	 ...
	 */
	public $depends = array('productcustomreferencenumber');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "productcustomreferencenumber@productcustomreferencenumber"));
		...
		// $this->hidden = !$user->hasRight('productcustomreferencenumber', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("ProductCustomReferenceNumberBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_productcustomreferencenumber@productcustomreferencenumber',
