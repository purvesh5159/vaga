...
/**
 *  \file       core/modules/productcustomreferencenumber/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_productcustomreferencenumber
 */
class pdf_standard_productcustomreferencenumber extends ModelePDFProductCustomReferenceNumber
{
	/**
	 ...
	 *
	 *  @param		ProductCustomReferenceNumber	$object				Object to generate
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  ProductCustomReferenceNumber	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('PRODUCTCUSTOMREFERENCENUMBER_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('PRODUCTCUSTOMREFERENCENUMBER_DRAFT_WATERMARK')));
		}
