 ...
 */
class mod_productcustomreferencenumber_elephant extends ModeleProductCode
{
	/**
	 ...
	 */
	public function getNextValue($objproduct = 0, $type = -1, $customprodtype='')
	{
		global $db, $conf;
		...
		if($type == 0 && !empty($customprodtype)){
			$mask = $customprodtype.'-{000000}';
		}elseif($type == 1 && !empty($customprodtype)){
			$mask = $customprodtype.'-{000000}';
		}
