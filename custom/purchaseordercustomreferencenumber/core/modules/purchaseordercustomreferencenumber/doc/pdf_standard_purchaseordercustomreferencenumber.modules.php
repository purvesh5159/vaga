...
/**
 *  \file       core/modules/purchaseordercustomreferencenumber/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_purchaseordercustomreferencenumber
 */
class pdf_standard_purchaseordercustomreferencenumber extends ModelePDFPurchaseOrderCustomReferenceNumber
{
	/**
	 ...
	 *
	 *  @param		PurchaseOrderCustomReferenceNumber	$object				Object to generate
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  PurchaseOrderCustomReferenceNumber	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('PURCHASEORDERCUSTOMREFERENCENUMBER_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('PURCHASEORDERCUSTOMREFERENCENUMBER_DRAFT_WATERMARK')));
		}
