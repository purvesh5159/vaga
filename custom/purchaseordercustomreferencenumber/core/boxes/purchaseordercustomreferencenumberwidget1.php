...
/**
 * \file    purchaseordercustomreferencenumber/core/boxes/purchaseordercustomreferencenumberwidget1.php
 * \ingroup purchaseordercustomreferencenumber
 * \brief   Widget provided by PurchaseOrderCustomReferenceNumber
 *
 ...
 */
class purchaseordercustomreferencenumberwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "purchaseordercustomreferencenumberbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "purchaseordercustomreferencenumber@purchaseordercustomreferencenumber";
	 ...
	 */
	public $depends = array('purchaseordercustomreferencenumber');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "purchaseordercustomreferencenumber@purchaseordercustomreferencenumber"));
		...
		// $this->hidden = !$user->hasRight('purchaseordercustomreferencenumber', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("PurchaseOrderCustomReferenceNumberBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_purchaseordercustomreferencenumber@purchaseordercustomreferencenumber',
