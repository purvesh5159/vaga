...
class Propal extends CommonObject
{
	...
	public function create($user, $notrigger = 0)
	{
		...
		$sql .= ", '(PROV)'";
		$sql .= ", '".(int) $this->revision."'";
		$sql .= ", '".(int) $this->revision_status."'";
	...
	{
		$sql = "SELECT p.rowid, p.ref, p.revision, p.revision_status, p.entity, p.fk_soc";
		...
		if ($resql) {
			if ($this->db->num_rows($resql)) {
				...
				$this->revision_status      = $obj->revision_status;
	...
	public function update(User $user, $notrigger = 0)
	{
		...
		if (isset($this->revision_status)) {
			$this->revision_status = trim($this->revision_status);
		}
		...
		$sql .= " revision_status=".(isset($this->revision_status) ? "'".$this->db->escape($this->revision_status)."'" : "null").",";
	...
	*/
	...
	public function LibStatut($status, $mode = 1)
	{
		...
		if (empty($this->labelStatus) || empty($this->labelStatusShort)) {
			...
			$this->labelStatus[5] = $langs->transnoentitiesnoconv("PropalStatusLost");
			$this->labelStatus[6] = $langs->transnoentitiesnoconv("PropalStatusCancelled");
			$this->labelStatus[7] = $langs->transnoentitiesnoconv("PropalStatusRevised");
			$this->labelStatus[8] = $langs->transnoentitiesnoconv("PropalStatusClosed");
			$this->labelStatus[9] = $langs->transnoentitiesnoconv("PropalStatusInActive");
			$this->labelStatus[10] = $langs->transnoentitiesnoconv("PropalStatusReview");
			$this->labelStatus[11] = $langs->transnoentitiesnoconv("PropalStatusPending");
		    ...
		    $this->labelStatusShort[5] = $langs->transnoentitiesnoconv("Lost");
			$this->labelStatusShort[6] = $langs->transnoentitiesnoconv("Cancelled");
			$this->labelStatusShort[7] = $langs->transnoentitiesnoconv("Revised");
			$this->labelStatusShort[8] = $langs->transnoentitiesnoconv("Closed");
			$this->labelStatusShort[9] = $langs->transnoentitiesnoconv("In Active");
			$this->labelStatusShort[10] = $langs->transnoentitiesnoconv("Review");
			$this->labelStatusShort[11] = $langs->transnoentitiesnoconv("Pending");
		}
		...
		if ($status == self::STATUS_DRAFT) {
			...
			$statusType = 'status6';
		} elseif ($status == self::STATUS_REVISED) {
			$statusType = 'status7';
...
class PropaleLigne extends CommonObjectLine
{
	...
	/**
	 * @deprecated
	 * @see revision added for add,update,delete
	 */
