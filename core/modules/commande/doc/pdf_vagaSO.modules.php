...
/**
 *	\file       htdocs/core/modules/commande/doc/pdf_vagaSO.modules.php
 *	\ingroup    commande
 *	\brief      File of Class to generate PDF orders with template vagaSO
 */
...
/**
 *	Class to generate PDF orders with template vagaSO
 */
class pdf_vagaSO extends ModelePDFCommandes
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "vagaSO";
		$this->description = $langs->trans('PDFvagaSODescription');
