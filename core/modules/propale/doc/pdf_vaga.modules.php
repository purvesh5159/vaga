                ...
                //        $nexY = max($pdf->GetY(), $nexY);
                  //  }
                    ...
                    */
                    ...
                    /* remove set if price not greater than 0 purvesh
                        ...
                        if (!empty($object->lines[$i]->array_options)) {
                            foreach ($object->lines[$i]->array_options as $extrafieldColKey => $extrafieldValue) {
                                ...
                                if ($this->getColumnStatus($extrafieldColKey)) {
                                    ...
                                    // Optional: only print 'options_uom' if it matches the current key or your logic
                                    if ($extrafieldColKey == 'options_uom' && isset($uom_value)) {
                                        $this->printStdColumnContent($pdf, $curY, 'options_uom', $uom_value);
                                    }
