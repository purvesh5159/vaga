...
class CommandeFournisseur extends CommonOrder
{
	...
	/* purchase ourder revision purvesh*/
	public $revision = 0;
	/**
	 * @var int ID
	 */
	...
	public function fetch($id, $ref = '')
	{
		...
		$sql = "SELECT c.rowid, c.entity, c.ref, c.revision, ref_supplier, c.fk_soc, c.fk_statut as status, c.amount_ht, c.total_ht, c.total_ttc, c.total_tva,";
	...
	public function LibStatut($status, $mode = 0, $billed = 0)
	{
		...
		if (empty($this->labelStatus) || empty($this->labelStatusShort)) {
			...
			$this->labelStatus[10] = 'StatusSupplierOrderInActive';
			...
			$this->labelStatusShort[10] = 'StatusSupplierOrderInActiveShort';
		}
